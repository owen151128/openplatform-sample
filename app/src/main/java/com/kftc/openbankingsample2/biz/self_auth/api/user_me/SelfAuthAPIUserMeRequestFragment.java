 ...
 * 사용자정보조회 요청
 */
public class SelfAuthAPIUserMeRequestFragment extends AbstractSelfAuthMainFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_self_auth_api_user_me_request, container, false);
        initView();
        return view;
    }
    ...
    void goNext() {
        startFragment(SelfAuthAPIUserMeResultFragment.class, args, R.string.fragment_id_api_call_userme);
    }
}
