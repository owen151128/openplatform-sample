...
import com.kftc.openbankingsample2.biz.center_auth.auth.authorize.CenterAuthAuthorizeCase2ChildFragment;
...
public class CenterAuthAuthorizeAccountFragment extends AbstractCenterAuthMainFragment {
    ...
    void initView() {
        ...
        tabHost.addTab(tabHost.newTabSpec("tab2").setIndicator("CASE 2"), CenterAuthAuthorizeCase2ChildFragment.class, args);
        ...
        tabHost.setOnTabChangedListener(tabId -> {
            ...
            switch(tabId){
                case "tab1":
                    ...
                    break;
                case "tab2":
                    fragmentClass = CenterAuthAuthorizeCase2ChildFragment.class;
    ...
    public void onBackPressed() {
        startFragment(CenterAuthFragment.class, args, R.string.fragment_id_auth);
    }
}
