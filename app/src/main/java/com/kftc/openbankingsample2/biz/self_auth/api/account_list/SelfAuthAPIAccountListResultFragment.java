 ...
 * 등록계좌조회 결과
 */
public class SelfAuthAPIAccountListResultFragment extends AbstractSelfAuthMainFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_self_auth_api_account_list_result, container, false);
        initView();
        return view;
    }
    ...
    void goNext() {
        startFragment(SelfAuthAPIFragment.class, null, R.string.fragment_id_api_call);
    }
}
