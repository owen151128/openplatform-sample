package com.kftc.openbankingsample2.biz.center_auth.api.account_cancel;
 ...
 * 계좌해지
 */
public class CenterAuthAPIAccountCancelFragment extends AbstractCenterAuthMainFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_center_auth_api_account_cancel, container, false);
        initView();
        return view;
    }
