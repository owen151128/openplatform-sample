...
public class SelfAuthHomeFragment extends AbstractSelfAuthMainFragment {
    ...
    private void initView() {
        ...
        // 계좌등록
        view.findViewById(R.id.btnAuthToken).setOnClickListener(v -> startFragment(SelfAuthFragment.class, args, R.string.fragment_id_auth));

        // API 거래
        view.findViewById(R.id.btnAPICallMenu).setOnClickListener(v -> startFragment(SelfAuthAPIFragment.class, args, R.string.fragment_id_api_call));
