...
public class CenterAuthAPIAccountTransactionResultFragment extends AbstractCenterAuthMainFragment {
    ...
    void initData() {
        ...
        // 다음 데이터가 더 있는지 확인
        beforInquiryTraceInfo = result.getBefor_inquirty_trace_info();
    ...
    void requestMoreDate() {
        ...
        String bankTranId = clientUseCode + "U" + randomUnique9String;
    ...
    Callback<Map> handleResponse = new Callback<Map>() {
        ...
        public void onResponse(Call<Map> call, Response<Map> response) {
            ...
            beforInquiryTraceInfo = nextResult.getBefor_inquirty_trace_info();
    ...
    void goNext() {
        startFragment(CenterAuthAPIFragment.class, null, R.string.fragment_id_api_call);
    }
}
