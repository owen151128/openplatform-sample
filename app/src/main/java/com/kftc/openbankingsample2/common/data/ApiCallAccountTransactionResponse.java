...
public class ApiCallAccountTransactionResponse implements Parcelable {
    ...
    private String befor_inquirty_trace_info;
    ...
    protected ApiCallAccountTransactionResponse(Parcel in) {
        ...
        befor_inquirty_trace_info = in.readString();
    }
    ...
    public String getBefor_inquirty_trace_info() {
        return befor_inquirty_trace_info == null ? "" : befor_inquirty_trace_info;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(befor_inquirty_trace_info);
    }
}
